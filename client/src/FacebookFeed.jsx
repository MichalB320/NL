...
export function FacebookFeed() {
  ...
  return (
    <section id="aktuality" className="py-20 relative transition-colors duration-300 bg-white dark:bg-slate-950/40">
      {/* Decentné fialové podsvietenie na pozadí pre dark mode */}
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex flex-col md:w-1/2 text-center md:text-center">
            <div className="inline-flex items-center justify-center md:justify-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 dark:bg-blue-950/60 dark:border dark:border-blue-800/40 rounded-full mb-4">
                <Facebook className="text-blue-600 dark:text-blue-400" size={32} />
              </div>
            </div>
            ...
            <p className="text-lg text-center dark:text-purple-200/80 text-gray-600">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="bg-gray-50 dark:bg-slate-900/60 dark:backdrop-blur-xl border border-gray-100 dark:border-purple-800/40 rounded-2xl p-3 sm:p-5 shadow-inner dark:shadow-purple-950/40 transition-colors">
