...
export function Hero() {
  ...
  return (
    <section id="domov" className="min-h-screen relative bg-gradient-to-br from-rose-50 via-pink-50 to-amber-50">
      
      <div className="absolute bottom-15 right-15 w-90 h-90 bg-pink-300/30 rounded-full blur-3xl"></div>
